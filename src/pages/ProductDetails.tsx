...
const ProductDetails = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row w-full min-h-screen bg-white outline-none overflow-x-hidden">
      
      {/* السايدبار الجانبي */}
      <div className="hidden md:block w-72 border-l border-gray-100 h-screen sticky top-0 shrink-0 overflow-y-auto">
        <Sidebar />
      </div>
          ...
          <div className="grid lg:grid-cols-2 gap-10 w-full mx-auto">
            ...
            <div className="flex flex-col justify-between">
              ...
              <div className="flex flex-col gap-3 pt-4 border-t border-gray-100">
                ...
                <button 
                  onClick={handleShare} 
                  className="flex items-center justify-center gap-2 w-full py-3 text-gray-500 font-semibold hover:text-black transition-all cursor-pointer"
                >
